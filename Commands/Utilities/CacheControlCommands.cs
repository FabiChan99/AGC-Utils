...
public sealed class CacheControlCommands : ApplicationCommandsModule
{
    ...
    public static async Task GetCacheValue(InteractionContext ctx,
        [Option("cachefile", "The cache file to get the value from.")]
        CustomDatabaseCacheType cachefile,
        [Option("key", "The key to get the value for.")]
        string key)
    {
    ...
    public static async Task SetCacheValue(InteractionContext ctx,
        [Option("cachefile", "The cache file to set the value for.")]
        CustomDatabaseCacheType cachefile,
        [Option("key", "The key to set the value for.")]
        string key,
    ...
    public static async Task ClearObjectFromCache(InteractionContext ctx,
        [Option("cachefile", "The cache file to delete the object from.")]
        CustomDatabaseCacheType cachefile,
