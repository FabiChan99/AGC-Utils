...
public class RoleplaySystem : ApplicationCommandsModule
{
    ...
    public async Task KissCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du küssen willst")] DiscordUser user)
    {
    ...
    public async Task PatCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du streicheln willst")] DiscordUser user)
    {
    ...
    public async Task KillCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du töten willst")] DiscordUser user)
    {
    ...
    public async Task LickCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du ablecken willst")] DiscordUser user)
    {
    ...
    public async Task BiteCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du beißen willst")] DiscordUser user)
    {
    ...
    public async Task CryCommand(InteractionContext ctx, [Option("user", "Den Nutzer mit dem du weinen willst")] DiscordUser user)
    {
    ...
    public async Task LoveCommand(InteractionContext ctx, [Option("user", "Den Nutzer den du lieben willst")] DiscordUser user)
    {
