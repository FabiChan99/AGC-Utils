...
public class StatsCommand // Disabled
{
    ...
    public static async Task Stats(InteractionContext ctx)
    {
        ...
        var botuptimeformatted =
            $"{botuptime.Days} days, {botuptime.Hours} hours, {botuptime.Minutes} minutes, {botuptime.Seconds} seconds";
        var lava = ctx.Client.GetLavalink();
        var node = lava.ConnectedSessions.First().Value;
        var lavauptime = node.Statistics.Uptime;
        var lavauptimeformatted =
            $"{lavauptime.Days} days, {lavauptime.Hours} hours, {lavauptime.Minutes} minutes, {lavauptime.Seconds} seconds";
        ...
        var sysuptimeformatted =
            $"{sysuptime.Days} days, {sysuptime.Hours} hours, {sysuptime.Minutes} minutes, {sysuptime.Seconds} seconds";
