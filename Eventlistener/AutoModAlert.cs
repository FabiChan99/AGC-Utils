...
public class AutoModAlert : BaseCommandModule
{
    ...
    private readonly bool AutoModAlertActive;
    ...
    {
        if (args.Channel.Id.ToString() != AutoModChannelId || !AutoModAlertActive) return Task.CompletedTask;
        ...
        var alertTask = new Task(async () =>
        {
            ...
            {
                if (field.Name is "rule_name" or "decision_id" or "channel_id") continue;
